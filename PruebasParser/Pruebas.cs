...
namespace PruebasParser
{
    ...
    public class Pruebas
    {
        ...
        public void TestExtSubOrd()
        {
            ...
            string e = null;
            var r = Parser._ExtSubOrd(ord, f, 0, ref e);
            Array.Sort(f);
        ...
        public void TestEsSub()
        {
            ...
            int l = a.Length;
            int[] ord = new int[l];
            bool r = Parser._EsSub(a, b, ref ord);
            Assert.IsTrue(r);
            int[] t = { 2, 0, 1, 3 };
            for (int i = 0; r && i != l; i++)
            {
        ...
        public void TestVacia()
        {
            ...
            var f = new string[l];
            string r = null;
            bool b = Parser._Vacía(t, l, 0, ref f, ref r);
            Assert.IsFalse(b && r == null);

            b = Parser._Vacía(t, l, 1, ref f, ref r);
            Assert.IsFalse(b && r == null);
        }
        ...
        public void TestObtEncabezado()
        {
            ...
            string r = null;
            int n = 0;
            var e = Parser._ObtEncabezado(t, perm, ref r, ref n);
        ...
        public void TestObTabla()
        {
            ...
            var t = new TablaPrueba();
            string r = null;
            ordEncabezado = Parser._ObtEncabezado(t, perm, ref r, ref n);
